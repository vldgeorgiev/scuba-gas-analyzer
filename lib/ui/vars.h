...
enum FlowGlobalVariables {
    ...
    FLOW_GLOBAL_VARIABLE_HE_TEMPERATURE = 13,
    FLOW_GLOBAL_VARIABLE_UI_LOG_LEVEL = 14,
    FLOW_GLOBAL_VARIABLE_BATT_VOLTAGE = 15,
    FLOW_GLOBAL_VARIABLE_CALIBRATE_ON_START = 16,
    FLOW_GLOBAL_VARIABLE_BRIGHTNESS = 17,
    FLOW_GLOBAL_VARIABLE_WIFI_LIST = 18
};
