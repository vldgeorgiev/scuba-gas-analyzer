...
lv_obj_t * largescr_create(void)
{
    ...
    if (lvgl_ui_project_check_target(LVGL_UI_PROJECT_TARGET_ALL)) {
        ...
        lv_obj_t * large_o2_row = row_create(column_0, 0, 0, 0, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
        ...
        lv_obj_t * large_he_row = row_create(column_0, 0, 0, 0, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
        ...
        lv_obj_t * large_status = row_create(column_0, 0, 0, 0, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
        lv_obj_set_name(large_status, "large_status");
        lv_obj_set_width(large_status, lv_pct(100));
        lv_obj_set_flag(large_status, LV_OBJ_FLAG_EVENT_BUBBLE, true);
        lv_obj_t * h4_0 = h4_create(large_status, "CO", "");
        lv_obj_set_width(h4_0, 60);
