...
- Consult `docs/testing.md` before test changes. Keep its suite counts, coverage map, environment
	selection, and validation boundaries current whenever related code or configuration changes.
